...
def newtrhapsmethod(func, funcderivetive, x, n):
    ...
    def f(x):
        ...
        return f
    def df(x):
        df = eval(funcderivetive)#OVO JE PRE DOBROOOOOOO ASDFKJGASDJHKFGASDHJKFGASDKHJFGASDHJKFGASDHJKFVGBASDKHJFGASDFHJKAGSD
        return df
...
print(generalbisection("math.cos(x)",1,2,0.004))#AAHHAHAHAHHAAAAAAAAAAAAAAAAAAAAAAAAHAHAAHAHAHAAHAHAHAHAHAHHAHAHAHAHHAHAAHHAHAHAHHAHAH
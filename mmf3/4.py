...
'''
D = 7
a = np.array([0, 1, 2, 3, 4, 5, 6])#in the first eqation there is no a that is why its a 0
b = np.array([2, 4, 6, 8, 6, 4, 2])
c = np.array([6, 5, 4, 3, 2, 1, 0])

d = np.array([0, 1, 2, 3, 2, 1, 0])
